...
"""
edx-repo-health documentation build configuration file.
...
#
# html_title = 'edx-repo-health v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Your project description goes here',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'repo_health'),
                os.path.join(root_path, 'repo_health/migrations')])
